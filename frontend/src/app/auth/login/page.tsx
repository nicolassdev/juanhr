...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#080b12] flex items-center justify-center p-4" style={{
      backgroundImage: 'radial-gradient(ellipse 80% 50% at 10% 20%, rgba(0,212,255,0.05) 0%, transparent 60%)',
    }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-cyan-400/10 border border-cyan-400/20 px-4 py-2 rounded-full mb-4">
            <span className="text-cyan-400 text-sm font-semibold">JuanHR v3</span>
          </div>
        ...
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                type="email" required placeholder="admin@juanhr.com"
                className="input"
                value={form.email}
        ...
        <p className="text-center text-slate-600 text-xs mt-6">
          Default: admin@juanhr.com / Admin@123
        </p>
      </div>
    </div>
  );
